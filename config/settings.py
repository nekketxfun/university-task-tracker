...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'uni_tracker_db'),
        'USER': os.getenv('DB_USER', 'tracker_admin'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'University Task Tracker API',
    'DESCRIPTION': 'API for optimizing university business processes',
    'VERSION': '1.0.0',
